                            ...
                            <tbody>
                                ...
                                @foreach ($advertises as $index => $advertise)
                                    <tr>
                                        ...
                                        <td><a href="{{ $advertise->redirect_url }}" target="_blank"><img width="100" src="{{ asset($advertise->banner) }}"
                                            alt="{{ $advertise->company_name }}"></a></td>
                                        <td>{{ $advertise->contact }} </td>
                                        <td>{{date('M-d Y', strtotime($advertise->expire_date ))}} </td>
