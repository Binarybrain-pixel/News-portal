                    ...
                    <form action="{{ route('advertise.update', $advertise->id) }}"  method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <input type="text" name="company_name" class="form-control" value="{{$advertise->company_name}}">
                                    @error('company_name')
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <input type="tel" name="contact" class="form-control" value="{{$advertise->contact}}">
                                    @error('contact')
                                        <p class="text-danger"> {{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <input type="date" name="expire_date" class="form-control" value="{{$advertise->expire_date}}>
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <input type="text" name="redirect_url" class="form-control" value="{{$advertise->redirect_url}}">
                                    @error('redirect_url')
                                        <p class="text-danger"> {{ $message }}</p>
                                    @enderror
                                </div>
